...
| 4.2. | [Network interfaces 2](https://www.dropbox.com/s/rj0xbul9gysiyyj/Verkkorajapinnat2.pdf?dl=0) | etc | 
| 11.2. | NAT, NTP, ARP, Bootp, DHCP | etc | 
| 18.2. | **Assignment #1** | etc | 
| 25.2. | Log files, intermediate feedback | etc | 
| 3.3. | ༼∩ຈل͜ຈ༽⊃━☆ﾟ. * ･ ｡ﾟ **Winter Holiday** | - | 
| 10.3. | Apache (LAMP) & SFTP | etc | 
| 17.3. | NFS, Samba | etc | 
| 24.3. | Performance & Stability | etc | 
| 31.3. | Docker | - | 
| 7.4. | **Assignment #2** | - | 
| 14.4. | **Exam** | - | 
